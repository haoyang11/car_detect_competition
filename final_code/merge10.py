...
arealist_1= "merge59\qwe58-test" # bbox
arealist_2= "merge59\six-test-600" # bbox
# validpath="0508valid"
outpath= arealist_2+"_add_json"
imgpath= arealist_2+"_img"
...
def run(k1, k2,areapath, N,imgfilename,areapath_sum,outfile):
  ...
  if np.mean(fitd)>20:
    # print(40)
    fitds=smooth_curve_v(list(fitd),40)
  else:
    # print(15)
  ...
  #if np.mean(xm_result)<4.5:
  for j in range(len(xm_result)):
      if xm_result[j] < 8:
        xm_result[j] += (8 - xm_result[j]) * 0.3
